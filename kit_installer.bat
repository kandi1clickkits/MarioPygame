...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/MarioPygame/releases/download/v1.0.0/MarioPygame.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/MarioPygame/raw/main/requirements.txt
SET REPO_NAME=SuperMario.zip
SET EXTRACTED_REPO_DIR=MarioPygame
SET NOTEBOOK_NAME=main.py
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
